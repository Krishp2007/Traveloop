...
Keeps SQLite for local dev; adjust DATABASES for production.
"""
...
# This part tells Django to use the Render database when deployed
...
# Email backend (prints to console — swap in production)
